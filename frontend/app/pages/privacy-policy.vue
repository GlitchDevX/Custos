<template>
  <UContainer>
    ...
    <ul>
      ...
      <li>
        <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or
          &quot;Our&quot; in this Agreement) refers to Custos.</p>
      </li>
      <li>
      ...
      <li>
        <p><strong>Website</strong> refers to Custos, accessible from <a href="https://custos.glitchdev.me"
            rel="external nofollow noopener" target="_blank">https://custos.glitchdev.me</a></p>
      </li>
      <li>
    ...
    <p>We use Cookies and similar tracking technologies to track the activity on Our Service and store certain
      information. Tracking technologies We use include beacons, tags, and scripts to collect and track information and
    ...
    <ul>
      ...
      <li>
        <p><strong>To provide You</strong> with news, special offers, and general information about other goods,
          services and events which We offer that are similar to those that you have already purchased or inquired about
    ...
    <p>Your information, including Personal Data, is processed at the Company's operating offices and in any other
      ...
      jurisdiction where the data protection laws may differ from those from Your jurisdiction.</p>
    ...
    <ul>
      <li>By email: contact@glitchdev.me</li>
    </ul>
